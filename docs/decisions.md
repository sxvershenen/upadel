...
- /gift: conversion-focused Swiss-style SEO landing for padel gift certificates in Moscow. Built strictly with design system atoms (Typography, Badge, Button, ButtonLink, SurfaceCard, Tabs, Accordion, Field, SelectField, CheckboxField, Reveal), non-breaking spaces on Russian prepositions, compact page-view hero with dark gradient and Varlion official partnership badge, use-cases grid (court rent, PRO coaches, Varlion gear, 2x2 games), 2 presentation formats (instant digital PDF in 2 mins and premium tactile box packaging with branded card and Varlion racket), interactive package tabs for 6 nominals (6 000 ₽ to 30 000 ₽), transparent 6-item terms grid (365 days, non-expiring balance, easy top-up, bearer certificate), padel facts section, interactive FAQ accordion, inline lead capture form with multi-channel selection (Telegram, Phone, VK) submitting to validated lead endpoint with first-party analytics tracking, and rich Schema.org JSON-LD (Product, FAQPage, BreadcrumbList, Organization).

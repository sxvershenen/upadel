      ...
      {open && (
        <>
          ...
          <motion.div
            ...
            className="se-sheet fixed inset-x-0 bottom-0 z-[80] max-h-[82svh] overflow-y-auto bg-white pb-[calc(24px+env(safe-area-inset-bottom))] pt-3 shadow-card-lg md:hidden"
          >
            ...
            <div className="flex items-center justify-between px-6 pb-2 pt-2">
              ...
              <motion.button
                ...
                onClick={onClose}
                aria-label="Закрыть"
                className="se-1 flex h-[var(--control-sm)] w-[var(--control-sm)] items-center justify-center bg-control text-ink focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-focus"
              >
                <X size={16} />
              </motion.button>
            </div>

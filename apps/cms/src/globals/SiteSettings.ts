      ...
      tabs: [
        ...
        },
        {
          ...
          fields: [
            ...
            { name: 'phoneDisplay', type: 'text', label: 'Телефон', defaultValue: '+7 985 835-00-55' },
          ...
          fields: [
            {
              ...
              fields: [
                ...
                { name: 'phoneEnabled', type: 'checkbox', label: 'Показывать окно перед звонком', defaultValue: true, admin: { description: 'Это не проверка номера: перед переходом на звонок посетитель увидит номер и подтвердит действие.' } },
                { name: 'emailEnabled', type: 'checkbox', label: 'Показывать окно перед email', defaultValue: true, admin: { description: 'Это не подтверждение адреса: перед открытием почты посетитель увидит адрес и подтвердит переход.' } },
                { name: 'telegramEnabled', type: 'checkbox', label: 'Показывать окно перед Telegram', defaultValue: true, admin: { description: 'Это не проверка аккаунта: перед переходом в Telegram посетитель подтвердит действие.' } },
                { name: 'vkEnabled', type: 'checkbox', label: 'Показывать окно перед VK', defaultValue: true, admin: { description: 'Это не проверка аккаунта: перед переходом в VK посетитель подтвердит действие.' } },
              ],
            },
          ],
        },

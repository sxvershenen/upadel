...
import { PageHeader, StickyBackLink } from '../thematic/PageHeader'
...
export function DetailPage({ dto }: { dto: DetailDTO }) {
  ...
  return <SiteFrame site={dto.site}>
    <PageHeader

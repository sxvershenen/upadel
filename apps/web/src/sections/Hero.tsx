        ...
        <div className="flex max-w-[980px] flex-col">
          ...
          <div data-hide-icons-narrow className="mt-6 flex flex-nowrap items-center gap-2 sm:mt-8 sm:gap-3">
            ...
            <div className="min-w-0 flex-1 sm:flex-none">
              <ContentAction data-hero-cta="secondary" reveal={false} action={hero.secondaryAction} variant="glass" size="lg" icon={<Play size={17} />} className="w-full min-w-0 whitespace-nowrap px-4 !leading-none text-[14px] sm:w-auto sm:px-5 sm:text-base">Попробовать</ContentAction>
            </div>

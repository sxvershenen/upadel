...
export function Blog() {
  ...
  return <section className="container-page py-20 md:py-28">
    <Reveal><SectionHeader eyebrow={home.blogSection.eyebrow} title={home.blogSection.title} action={<SectionAction action={home.blogSection.action}>{home.blogSection.action.label?.replace(/\s*[→↗]+$/, '') || 'Все'}</SectionAction>} className="mb-10" /></Reveal>

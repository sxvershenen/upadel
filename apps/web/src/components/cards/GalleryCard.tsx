...
export function GalleryCard({ src, alt = "Момент из жизни клуба" }: { src: string; alt?: string }) {
  ...
  return <motion.div {...revealAttributes(true)} initial="rest" whileHover="hover" variants={{ rest: { y: 0, scale: 1 }, hover: { y: -4, scale: 1.012 } }} transition={springSoft} className="card-spring se-3 h-[190px] w-[240px] shrink-0 overflow-hidden md:h-[250px] md:w-[320px]">

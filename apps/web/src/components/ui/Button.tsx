...
export const ButtonLink = forwardRef<HTMLAnchorElement, ButtonLinkProps>(
  ({ variant = "primary", size = "md", icon, iconPosition, iconDivider, fullWidth, iconOnly, reveal = true, className, children, style, ...nativeProps }, ref) => <motion.a ref={ref} data-button-link="true" whileHover={{ scale: 1.025 }} whileTap={tapScale} transition={springSnappy} className={cn(baseClasses, variantClasses[variant], sizeClasses[size], fullWidth && "w-full", className)} {...nativeProps} {...revealAttributes(reveal, style)}>

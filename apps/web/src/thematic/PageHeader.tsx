...
export function PageHeader({ page, actions }: { page: PageHeaderData; actions?: ReactNode }) {
  return <header className="page-hero relative isolate overflow-hidden py-12 text-white md:py-16">
      ...
      <div className="container-page">
        {page.eyebrow ? <span data-page-enter="eyebrow" className="type-eyebrow block text-white/50">{page.eyebrow}</span> : null}
        <h1 data-page-enter="title" className="type-section mt-3 max-w-[920px] text-white">{page.title}</h1>

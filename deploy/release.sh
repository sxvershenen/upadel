...
required=(DATABASE_URL PAYLOAD_SECRET PREVIEW_SECRET PUBLIC_WEB_URL PUBLIC_CMS_URL PUBLIC_SITE_URL CMS_URL LEAD_ALLOWED_ORIGINS ANALYTICS_ALLOWED_ORIGINS ANALYTICS_JOB_SECRET PAYLOAD_ADMIN_ROUTE ADMIN_USERNAME ADMIN_EMAIL ADMIN_PASSWORD)
